...
public class AddDishActivity extends AppCompatActivity implements View.OnClickListener,
        ColorDialog.IColorPicked, IconDialog.IDialogResult, CalculatorDialog.IDialogCalculator, IDishContract.IView {
    ...
    private IDishContract.IPresenter mIPresenter;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_dish);
        mIPresenter = new AddDishPresenter(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.lnUnitName: {
                startActivity(new Intent(AddDishActivity.this, SelectUnitActivity.class));
                break;
            }
